    ...
    <div class="flexslider-container">
        <div id="gallery-slider" class="flexslider">
            <ul class="slides">
                ...
                ?>
                <li class="slide hello "><img src="<?php $imageStuff = wp_get_attachment_image_src( $wpex_single_gallery_attachment->ID, 'large' ); echo $imageStuff[0]; ?>" alt="<?php echo the_title(); ?>" /></li>
                <?php } endforeach; ?>
            </ul><!-- /slides -->
        </div><!-- /flexslider -->
